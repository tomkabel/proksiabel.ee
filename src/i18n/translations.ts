export const translations = {
  en: {
    ...
    nav: {
      ...
      statusOperational: 'Available for audits',
      openMenu: 'Open menu',
    ...
    hero: {
      ...
      graph: {
        tag: 'AiTM attack vector',
        client: 'Client',
        proxy: 'AiTM Proxy',
        target: 'Target App',
        session: 'Session',
        tokenHijack: 'Token Hijack',
        bypass: 'MFA Bypass',
      ...
      terminal: {
        ...
        demo: 'demo',
        cmd: 'proksiabel --assess your-app.example',
        lines: [
          '[+] target resolved · 3 endpoints',
          '[~] fingerprinting stack…',
          '[+] TLS 1.3 · HSTS · cert valid',
          '[~] probing auth endpoints…',
          '[!] session cookie: predictable pattern',
          '[!] /login: no rate limiting',
          '[~] checking client-side protections…',
          '[!] checkout: no bot mitigation',
          '[+] scan complete · 3 findings',
        ],
        footer: "simulated scan — a real engagement finds what a scanner PDF can't.",
        svc1: 'pen test',
        svc2: 'secure dev',
        svc3: 'research',
      },
    ...
    expertise: {
      ...
      dossierLabel: 'Operator',
      quote: "An attacker doesn't read your requirements doc. They look for the single logic flaw.",
      arsenalTitle: 'Technical arsenal & focus',
      recognition: {
        title: 'Recognition',
        project: 'RedSWAT — AI/GovTech Hackathon 2026',
        detail:
          'Award-winning team with AMEDIA (Kyiv): AI-driven automated penetration testing of government code.',
        link: 'Read the announcement',
        url: 'https://www.gtaua.org/en-blogs/gta-ua-member-companies-win-awards-at-the-ukrainian-estonian-ai-govtech-hackathon',
      },
      disclosure: {
    ...
    contact: {
      ...
      dispatchTag: 'Encrypted dispatch terminal',
      directTitle: 'Ready to test your systems?',
      directIntro: 'Direct line to the specialist. No sales layer in between.',
      pgpTitle: 'PGP key',
      copy: 'Copy',
      copied: 'PGP fingerprint copied!',
      downloadKey: 'Download .asc',
      directLink: 'Direct link',
      ndaNote: 'Reply within 24h. NDA guaranteed.',
      form: {
  ...
  et: {
    ...
    nav: {
      ...
      bookAudit: 'Broneeri audit',
      statusOperational: 'Saadaval audititeks',
      openMenu: 'Ava menüü',
    ...
    hero: {
      ...
      graph: {
        tag: 'AiTM ründevektor',
        client: 'Klient',
        proxy: 'AiTM proksi',
        target: 'Sihtrakendus',
        session: 'Sessioon',
        tokenHijack: 'Tokeni kaaperdus',
        bypass: 'MFA möödahiilimine',
      ...
      terminal: {
        ...
        demo: 'demo',
        cmd: 'proksiabel --assess teie-rakendus.example',
        lines: [
          '[+] sihtmärk tuvastatud · 3 otspunkti',
          '[~] tuvastan tehnoloogiat…',
          '[+] TLS 1.3 · HSTS · sertifikaat kehtiv',
          '[~] otsin autentimislüüse…',
          '[!] sessiooniküpsis: etteaimatav muster',
          '[!] /login: rate limiting puudub',
          '[~] kontrollin kliendipoolseid kaitseid…',
          '[!] checkout: bot-tõrjet pole',
          '[+] skaneerimine lõppenud · 3 leidu',
        ],
        footer:
          'simuleeritud skaneerimine — päris töövõtt leiab selle, mida skänneri PDF ei suuda.',
        svc1: 'pentest',
        svc2: 'turvaline arendus',
        svc3: 'uuring',
      },
    },
    services: {
      ...
      bento: {
        sectionTag: 'Võimekus',
        reportPreview: 'Näidisleid',
        severity: 'Kriitiline',
        cvss: 'CVSS 9.8',
        findingType: 'Autentimise möödahiilimine / race condition',
    ...
    expertise: {
      ...
      dossierLabel: 'Operaator',
      quote: 'Ründaja ei loe su nõuete dokumenti. Ta otsib ühtainsat loogikaviga.',
      arsenalTitle: 'Tehniline arsenal ja fookus',
      recognition: {
        title: 'Tunnustus',
        project: 'RedSWAT — AI/GovTech häkaton 2026',
        detail:
    ...
    contact: {
      ...
      dispatchTag: 'Krüpteeritud saatmisterminal',
      directTitle: 'Valmis oma süsteeme testima?',
      directIntro: 'Otsesuhtlus spetsialistiga. Ilma müügiosakonna vahenduseta.',
      pgpTitle: 'PGP võti',
      copy: 'Kopeeri',
      copied: 'PGP sõrmejälg kopeeritud!',
      downloadKey: 'Lae .asc alla',
      directLink: 'Otselink',
      ndaNote: 'Vastus 24h jooksul. NDA tagatud.',
      form: {
        title: 'Saada sõnum',
        name: 'Nimi',
    ...
    footer: {
      ...
      company: 'Ettevõte',
      registrationLabel: 'Reg.',
      signedNote: 'Krüpteeritud ja allkirjastatud',
      brandDescription:
