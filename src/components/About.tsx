import { Building, CheckCircle2, Code, Mail, MapPin, Phone, Shield, Wrench } from 'lucide-react';
    ...
    <section id='about' className='section-padding relative overflow-hidden'>
      <div className='relative z-10 container-custom'>
        ...
        <div className='text-center mb-16 animate-fade-in'>
          ...
          <p className='body-large text-slate-400 max-w-3xl mx-auto'>{t.about.subtitle}</p>
        </div>
        ...
        <div className='grid lg:grid-cols-3 gap-8'>
                  ...
                  <div className='flex items-start gap-3'>
                    ...
                    <div>
                      ...
                      <p className='text-white font-medium'>
                        {contactInfo.company.registrationCode}
                      </p>
                    </div>
                  </div>
          ...
          <div className='animate-slide-up stagger-2'>
            <div className='glass-card p-8 h-full'>
              ...
              <p className='text-slate-400 mb-6'>{t.about.productsIntro}</p>
          ...
          <div className='lg:col-span-3 animate-slide-up stagger-3'>
            <div className='glass-card p-8 md:p-10'>
              ...
              <div className='grid md:grid-cols-2 xl:grid-cols-3 gap-8'>
                ...
                <div className='relative pl-6'>
                  <div className='absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-sky-500 to-teal-500 rounded-full' />
                  <p className='text-slate-300 leading-relaxed'>{t.about.missionText2}</p>
                </div>
                <div className='relative pl-6'>
                  <div className='absolute left-0 top-0 bottom-0 w-0.5 bg-gradient-to-b from-sky-500 to-teal-500 rounded-full' />
                  <p className='text-slate-300 leading-relaxed'>{t.about.missionText3}</p>
                </div>
              </div>
            </div>
          </div>
