import { Award, Code, Eye, MapPin, Shield } from 'lucide-react';
        ...
        <div className='grid lg:grid-cols-2 gap-12 lg:gap-16 items-center'>
          ...
          <div className='animate-slide-up stagger-2'>
            ...
            <div className='space-y-4 mb-10'>
              <p className='text-slate-300 text-lg leading-relaxed'>{t.expertise.bio1}</p>
              <p className='text-slate-400 leading-relaxed'>{t.expertise.bio2}</p>
            </div>
