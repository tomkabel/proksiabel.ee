      ...
      <div className='max-w-content mx-auto px-6 lg:px-8'>
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16'>
          ...
          <div>
            ...
            <div className='p-8 rounded-2xl border border-white/5 bg-slate-900'>
              {/* Legal note */}
              <div className='flex items-center gap-3 px-4 py-3 mb-6 rounded-xl border border-sky-400/20 bg-sky-400/5'>
                ...
                <form ref={formRef} onSubmit={handleSubmit} className='space-y-5' noValidate>
                  <div>
                    ...
                    <input
                      ...
                      className='w-full px-4 py-3 rounded-lg bg-slate-950 border border-white/10 text-white text-sm placeholder:text-slate-400 focus:outline-none focus:border-sky-400/50 transition-colors'
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 rounded-lg bg-slate-950 border text-white text-sm placeholder:text-slate-400 focus:outline-none transition-colors ${
                        emailError ? 'border-red-500' : 'border-white/10 focus:border-sky-400/50'
                      }`}
                    />
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className='w-full px-4 py-3 rounded-lg bg-slate-950 border border-white/10 text-white text-sm placeholder:text-slate-400 focus:outline-none focus:border-sky-400/50 transition-colors resize-none'
                    />
                  </div>

                  <button
                    type='submit'
                    className='w-full py-3 rounded-lg bg-sky-600 text-white font-bold text-sm hover:bg-sky-500 transition-colors focus:outline-none focus:ring-2 focus:ring-sky-400/50'
                  >
