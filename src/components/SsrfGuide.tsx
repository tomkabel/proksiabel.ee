      ...
      <div className='min-h-screen bg-slate-900 pt-24 pb-12'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-slate-400 text-lg leading-relaxed mb-10'>
            ...
            server send requests anywhere that server can reach: localhost, internal networks, cloud
            metadata. It is CWE-918, entered OWASP&apos;s Top 10 as A10:2021, and in the 2025
          ...
          <div className='max-w-none text-slate-300'>
            <section className='mb-10'>
              ...
              <p className='leading-relaxed mb-4'>
                ...
                taxonomy change, not a risk change — the underlying weakness, CWE-918 (Server-Side
                Request Forgery), is the same, and the cloud-metadata angle keeps it at the top of
                every bug-bounty program&apos;s payout table.
              </p>
            ...
            <section className='mb-10'>
              ...
              <p className='leading-relaxed mb-4'>
                SSRF attacks abuse the trust other systems place in the vulnerable
                application&apos;s network position. Concretely:
              </p>
              <ul className='list-disc list-inside space-y-2 mb-4'>
                ...
                <li>
                  <strong className='text-sky-400'>Against back-end systems</strong> — pointing it
                  at RFC 1918 addresses such as{' '}
                  <code className='text-slate-100'>http://192.168.0.68/admin</code>. Internal
                  services are often unauthenticated because the network topology was the only
                  control.
                </li>
                <li>
...
stockApi=http://localhost/admin`}
            ...
            <section className='mb-10'>
              ...
              <p className='leading-relaxed mb-4'>
                ...
                weaponized payloads. The lab emulates the AWS metadata endpoint at its real address,{' '}
                <code className='text-slate-100'>169.254.169.254</code>, using a Docker network with
                a link-local subnet.
              </p>
      ...
      config:
        - subnet: 169.254.0.0/16`}
              ...
              <p className='leading-relaxed mb-4'>
                ...
                that address in every walkthrough URL below. The behavior is identical — only the IP
                changes.
              </p>
...
<!doctype html>`}
              ...
              <p className='leading-relaxed mb-4'>
                Now the metadata credential theft — this is the Capital One chain in miniature. One
...
internal-only: flag{ssrf-locally-verified}`}
              ...
              <ul className='list-disc list-inside space-y-2 mb-4'>
                <li>
                  ...
                  scheme, so this raises <code className='text-slate-100'>InvalidSchema</code>. The
                  same is not true of stacks with richer scheme support (curl, Go&apos;s stdlib with
                  custom handlers, some Java HTTP clients) — scheme abuse is stack-dependent, which
                  is why OWASP lists <code className='text-slate-100'>file://</code>,{' '}
                ...
                <li>
                  ...
                  rejects <code className='text-slate-100'>file://</code> — but accepts every attack
                  that matters. Scheme filtering alone is not a defense.
                </li>
                <li>
                  ...
                  attack through a redirect you control.{' '}
                  <code className='text-slate-100'>requests</code> follows redirects by default, so
                  a URL like{' '}
                  <code className='text-slate-100'>
                    http://attacker.example/r?to=http://127.0.0.1:8080/flag
                  </code>{' '}
                  sails past the filter. On Linux,{' '}
                  <code className='text-slate-100'>http://0.0.0.0:8080/flag</code> also works: the
                  kernel routes connections to the unspecified address to loopback.
                </li>
              </ul>
            </section>
            ...
            <section className='mb-10'>
              ...
              <p className='leading-relaxed mb-4'>
                ...
                not mitigate SSRF with a deny-list or regex. The table below is the standard bypass
                catalog (PortSwigger&apos;s Web Security Academy is the canonical reference):
              </p>
              <div className='overflow-x-auto mb-4'>
                <table className='w-full text-sm text-left border-collapse'>
                  <thead>
                  ...
                  <tbody className='text-slate-300'>
                    <tr className='border-b border-slate-800'>
                      ...
                      <td className='py-3 align-top'>
                        <code className='text-slate-100'>2130706433</code> (decimal 127.0.0.1),{' '}
                        <code className='text-slate-100'>127.1</code>,{' '}
                    ...
                    <tr className='border-b border-slate-800'>
                      ...
                      <td className='py-3 pr-4 align-top'>
                        Cross-scheme redirects and protocol confusion — the first request is https,
                        the redirect target is gopher, dict, or file.
                      </td>
                      <td className='py-3 align-top'>
                    ...
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        Hostname validation, no re-check on connect
                      </td>
                      <td className='py-3 pr-4 align-top'>
      ...
      - pattern-either:
          ...
          - pattern: requests.request($METHOD, $URL, ...)`}
              ...
              <p className='leading-relaxed mb-4'>
                ...
                <code className='text-slate-100'>fetch_safe()</code>, the rule matches your own safe
                call sites. Add a <code className='text-slate-100'>pattern-not</code> for the helper
                or move the rule to review-only severity.
              </p>
...
alert http any any -> any any (msg:"SSRF: link-local metadata host as destination"; \\
  ...
  classtype:attempted-info-leak; sid:1000002; rev:1;)`}
              ...
              <ul className='list-disc list-inside space-y-2 mb-4'>
                ...
                <li>
                  Non-HTTP schemes in fetch parameters (
                  <code className='text-slate-100'>gopher</code>,{' '}
                  <code className='text-slate-100'>dict</code>,{' '}
                  <code className='text-slate-100'>file</code>).
                </li>
                <li>
                  The redirect flavor of the attack leaves a distinctive two-hop trace: an outbound
                  fetch to an external host followed within milliseconds by a loopback or internal
                  request.
                </li>
              </ul>
            </section>
              ...
              <div className='overflow-x-auto mb-4'>
                <table className='w-full text-sm text-left border-collapse'>
                  ...
                  <tbody className='text-slate-300'>
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        The app only ever calls identified, trusted applications (internal services,
                        a fixed API)
                      </td>
                      <td className='py-3 align-top'>
                        Positive allowlist: exact hostname/IP list, scheme and port allowlist,
                        redirects disabled. Validate with parser-safe libraries (e.g. Apache Commons
                        Validator in Java, <code className='text-slate-100'>ip-address</code> in JS,{' '}
                        <code className='text-slate-100'>ipaddress</code> in Python).
                      </td>
                    </tr>
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                    ...
                    <tr className='border-b border-slate-800'>
                      ...
                      <td className='py-3 align-top'>
                        Network segmentation: run URL-fetching functionality in its own segment so a
                        compromise does not reach the whole backend. Never echo raw responses to the
                        client when the Content-Type is non-text.
                      </td>
                    </tr>
                  </tbody>
                </table>
  ...
  return res;
              ...
              <ul className='list-disc list-inside space-y-2 mb-4'>
                <li>
                  ...
                  deny-by-default egress firewall rules so the app tier can only reach what it must
                  (OWASP A10:2021 network-layer guidance).
                </li>
                <li>
                  AWS: enable IMDSv2 and disable IMDSv1. IMDSv2 requires a PUT-obtained session
                  token plus the <code className='text-slate-100'>X-aws-ec2-metadata-token</code>{' '}
                  header, so a plain GET-based SSRF can no longer read credentials directly. This is
                  a defense-in-depth layer, not a replacement for input validation — an SSRF with
                ...
                <li>
                  ...
                  deny-list table blocks all of them plus RFC 1918, loopback, and multicast ranges
                  as a minimum.
                </li>
              </ul>
            </section>
              ...
              <div className='overflow-x-auto mb-4'>
                <table className='w-full text-sm text-left border-collapse'>
                  ...
                  <tbody className='text-slate-300'>
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        Every server-side fetch is inventoried (requests, urllib, http, fetch, curl,
                        proxy rules)
                      </td>
                      <td className='py-3 align-top'>
                    ...
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        Scheme allowlist enforced (http/https)
                      </td>
                      <td className='py-3 align-top'>
                    ...
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        Redirects disabled or re-validated per hop
                      </td>
                      <td className='py-3 align-top'>
                    ...
                    <tr className='border-b border-slate-800'>
                      ...
                      <td className='py-3 align-top'>
                        Lab walkthrough request — expect block; network signature fires on metadata
                        path
                      </td>
                    </tr>
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        Egress firewall deny-by-default from app tier
                      </td>
                      <td className='py-3 align-top'>
                    ...
                    <tr className='border-b border-slate-800'>
                      <td className='py-3 pr-4 align-top'>
                        IMDSv2 enforced, IMDSv1 disabled (AWS)
                      </td>
                      <td className='py-3 align-top'>
            ...
            <section className='mb-10'>
              ...
              <ul className='list-disc list-inside space-y-2 mb-4'>
                <li>
                  SSRF converts the application&apos;s trusted network position into a proxy for the
                  attacker — firewalls and ACLs are irrelevant once the fetch is
                  attacker-controlled.
                </li>
                <li>
                  The metadata chain (169.254.169.254 → IAM credentials → S3/control plane) is the
                  highest-impact variant; it drove the Capital One breach and remains a current
                  initial-access vector (CVE-2026-15409, KEV July 2026).
                </li>
                <li>
                  Allowlists beat deny-lists; deny-lists are a documented last resort. Whatever you
                  use, validate every resolved IP, pin the connection, and disable redirects.
                </li>
                <li>
            ...
            <section className='mb-10 border-t border-slate-800 pt-8'>
              ...
              <p className='leading-relaxed mb-4'>
                ...
                metaandmete lõpp-punkti (169.254.169.254) poole. Nii saab varastada IAM-mandaate ja
                pääseda ligi sisemistele süsteemidele, mida tulemüür kaitseb. Peamised kaitsed:
              ...
              <ul className='list-disc list-inside space-y-1 text-sm'>
                <li>
                  <a
                    ...
                    href='https://owasp.org/Top10/2021/A10_2021-Server-Side_Request_Forgery_(SSRF)/'
                  >
                ...
                <li>
                  ...
                  >
                    OWASP Top 10:2025 — Introduction (SSRF rolled into A01)
                  </a>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    className='text-sky-400 hover:text-sky-300'
                    href='https://aws.amazon.com/blogs/security/defense-in-depth-open-firewalls-reverse-proxies-ssrf-vulnerabilities-ec2-instance-metadata-service/'
                  >
                    AWS Security Blog — IMDSv2 defense in depth
                  </a>
                </li>
                <li>
                  <a
                  ...
                  >
                    Apache HTTP Server vulnerabilities — CVE-2021-40438
                  </a>
                </li>
                <li>
                  <a
                ...
                <li>
                  ...
                  >
                    MITRE ATT&amp;CK T1190 / <span className='text-slate-300'>T1552.005</span>{' '}
                ...
                <li>
                  <a
                    className='text-sky-400 hover:text-sky-300'
                    href='https://www.capitalone.com/facts2019/'
                  >
                    Capital One — 2019 incident facts
                  </a>
                  ;{' '}
                  <a
                    className='text-sky-400 hover:text-sky-300'
                    href='https://dl.acm.org/doi/10.1145/3546068'
                  >
                    systematic analysis (ACM)
                  </a>
                </li>
                <li>
                  <a
