      ...
      <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='max-w-none text-slate-300'>
          <section className='mb-8'>
            ...
            <p className='text-slate-300 leading-relaxed'>{t.legal.privacy.intro.text}</p>
            <p className='text-slate-300 leading-relaxed mt-4'>{t.legal.privacy.intro.text2}</p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <div className='text-slate-300 space-y-1'>
              <p>
                <strong className='text-sky-400'>{t.legal.privacy.controller.name}</strong>
              </p>
          ...
          <section className='mb-8'>
            ...
            <div className='space-y-6'>
              <div>
                <h3 className='text-lg text-sky-400 font-medium mb-2'>
                  {t.legal.privacy.dataCollected.automatic.title}
                </h3>
                <p className='text-slate-300 leading-relaxed'>
                  {t.legal.privacy.dataCollected.automatic.text}
                </p>
                <ul className='list-disc list-inside text-slate-300 space-y-1 mt-2'>
                  {t.legal.privacy.dataCollected.automatic.items.map((item: string) => (
                    <li key={item}>{item}</li>
                  ))}
                </ul>
                <p className='text-slate-300 leading-relaxed mt-2 italic'>
                  {t.legal.privacy.dataCollected.automatic.note}
                </p>
              </div>
              <div>
                <h3 className='text-lg text-sky-400 font-medium mb-2'>
                  {t.legal.privacy.dataCollected.provided.title}
                </h3>
                <p className='text-slate-300 leading-relaxed'>
                  {t.legal.privacy.dataCollected.provided.text}
                </p>
                <ul className='list-disc list-inside text-slate-300 space-y-1 mt-2'>
                  {t.legal.privacy.dataCollected.provided.items.map((item: string) => (
                    <li key={item}>{item}</li>
                  ))}
                </ul>
              </div>
          ...
          <section className='mb-8'>
            ...
            <div className='space-y-4'>
              <div>
                <h3 className='text-lg text-sky-400 font-medium mb-2'>
                  {t.legal.privacy.legalBasis.consent.title}
                </h3>
                <p className='text-slate-300 leading-relaxed'>
                  {t.legal.privacy.legalBasis.consent.text}
                </p>
              </div>
              <div>
                <h3 className='text-lg text-sky-400 font-medium mb-2'>
                  {t.legal.privacy.legalBasis.legitimate.title}
                </h3>
                <p className='text-slate-300 leading-relaxed'>
                  {t.legal.privacy.legalBasis.legitimate.text}
                </p>
              </div>
              <div>
                <h3 className='text-lg text-sky-400 font-medium mb-2'>
                  {t.legal.privacy.legalBasis.legal.title}
                </h3>
                <p className='text-slate-300 leading-relaxed'>
                  {t.legal.privacy.legalBasis.legal.text}
                </p>
              </div>
            </div>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc list-inside text-slate-300 space-y-1 mt-2'>
              {t.legal.privacy.dataUsage.items.map((item: string) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc list-inside text-slate-300 space-y-1 mt-2'>
              {t.legal.privacy.dataSharing.items.map((item: string) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
            <p className='text-slate-300 leading-relaxed mt-4'>
              {t.legal.privacy.dataSharing.transfers}
            </p>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc list-inside text-slate-300 space-y-1 mt-2'>
              {t.legal.privacy.retention.items.map((item: string) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </section>
          ...
          <section className='mb-8'>
            ...
            <ul className='list-disc list-inside text-slate-300 space-y-1 mt-2'>
              {t.legal.privacy.security.items.map((item: string) => (
                <li key={item}>{item}</li>
              ))}
            </ul>
          </section>
          ...
          <section className='mb-8'>
            ...
            <p className='text-slate-300 leading-relaxed mt-2'>
              <strong className='text-sky-400'>{t.legal.privacy.cookies.essential}</strong>
            </p>
            <p className='text-slate-300 leading-relaxed mt-2'>
              <strong className='text-red-400'>{t.legal.privacy.cookies.noAnalytics}</strong>
            </p>
          </section>
