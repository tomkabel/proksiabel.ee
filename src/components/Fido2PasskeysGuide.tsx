    ...
    <>
      ...
      <div className="min-h-screen bg-slate-900 pt-24 pb-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-white mb-6">FIDO2 vs Passkeys: A Technical Guide</h1>
          ...
          <div className="max-w-none text-slate-300">
            <section className="mb-10">
              ...
              <ul className="list-disc list-inside space-y-2 mb-4">
                <li>
                  ...
                  browser-to-server API (<code className="text-slate-100">navigator.credentials.create()</code>{' '}
                  and <code className="text-slate-100">get()</code>). It defines the challenge flow,
            ...
            <section className="mb-10">
              <h2 className="text-xl text-sky-500 font-semibold mb-4">What passkeys actually are</h2>
              <p className="leading-relaxed mb-4">
              ...
              <p className="leading-relaxed">
                The practical consequence: <em>every passkey is a FIDO2 credential, but not every
                FIDO2 credential is a passkey.</em> A security key with attestation and no sync is
                FIDO2, but nobody calls it a passkey.
              </p>
            </section>
            ...
            <section className="mb-10">
                ...
                <table className="w-full text-sm text-left border-collapse">
                  <thead>
                    <tr className="border-b border-slate-700">
                      ...
                      <th className="py-3 pr-4 text-slate-100 font-semibold">Security key (CTAP2)</th>
                  ...
                  <tbody className="text-slate-300">
                    ...
                    <tr className="border-b border-slate-800">
                      ...
                      <td className="py-3 align-top">Cross-device via QR + BLE (hybrid transport)</td>
                    </tr>
                    <tr className="border-b border-slate-800">
                      <td className="py-3 pr-4 align-top">signCount</td>
                      <td className="py-3 pr-4 align-top">Increments — usable for clone detection</td>
                      <td className="py-3 align-top">Often 0 on platform authenticators</td>
                    </tr>
                    <tr className="border-b border-slate-800">
                      <td className="py-3 pr-4 align-top">Loss / recovery</td>
                      <td className="py-3 pr-4 align-top">Register multiple keys; lost key = lost access</td>
                      <td className="py-3 align-top">Provider sync + account recovery</td>
                    </tr>
                    <tr>
                      <td className="py-3 pr-4 align-top">Enterprise control</td>
                      <td className="py-3 pr-4 align-top">AAGUID allowlists, attestation policies</td>
              ...
              <p className="leading-relaxed mb-6">
                ...
                with the server: the browser sends a list of credential IDs and the key picks one.
                A passkey is a resident key — the authenticator holds the credential and can be asked
              ...
              <p className="leading-relaxed mb-6">
                ...
                <code className="text-slate-100">bs: false</code>. Relying parties that need
                strict device-binding can read these flags and reject credentials that do not meet
                the policy.
              </p>
              ...
              <p className="leading-relaxed">
                ...
                per registration ({' '}
                <code className="text-slate-100">userVerification: "required" | "preferred" | "discouraged"</code>{' '}
            ...
            <section className="mb-10">
              ...
              <p className="leading-relaxed mb-4">
                ...
                secrets, challenge-response authentication. Credential stuffing and classic
                phishing fail against both, because a credential minted for{' '}
              ...
              <p className="leading-relaxed">
                ...
                reverse-proxy phishing kit (AiTM-style) still rides the session cookie once the
                user has signed in. Passkeys move the credential layer forward — they do not make
            ...
            <section className="mb-10">
              ...
              <h3 className="text-lg text-sky-400 font-medium mb-3">Consumer-facing apps: passkeys</h3>
              <p className="leading-relaxed mb-6">
                Sync, recovery, and cross-device flows are what consumers expect. The UX win is
                real, and the backup-eligibility flags let you set a sane policy instead of
                blocking the ecosystem.
              </p>

              <h3 className="text-lg text-sky-400 font-medium mb-3">Privileged access: device-bound security keys</h3>
              <p className="leading-relaxed mb-6">
                Admin consoles, break-glass accounts, and anything holding signing keys benefit
                from attestation, AAGUID allowlisting, and a private key that provably never left
                hardware. No cloud dependency, no provider-mediated recovery.
              </p>

              <h3 className="text-lg text-sky-400 font-medium mb-3">Hybrid is the common pattern</h3>
              <p className="leading-relaxed">
            ...
            <section className="mb-10">
              <h2 className="text-xl text-sky-500 font-semibold mb-4">Relying-party implementation checklist</h2>
              <ul className="list-disc list-inside space-y-2 mb-6">
                ...
                <li>
                  Read the <code className="text-slate-100">be</code> / <code className="text-slate-100">bs</code>{' '}
                  flags and enforce your backup policy — do not silently accept synced credentials
                  where device-binding is required.
                </li>
                <li>
              ...
              <p className="leading-relaxed mb-4">A registration that accepts both looks like this:</p>
    ...
    attestation: "none"                  // "direct" for privileged roles
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 text-sm">
                <li>
                  W3C —{' '}
                  <a className="text-sky-400 hover:text-sky-300" href="https://www.w3.org/TR/webauthn-3/" rel="noopener noreferrer">
                    Web Authentication: An API for accessing Public Key Credentials (Level 3)
                  </a>
                </li>
                <li>
                  FIDO Alliance —{' '}
                  <a className="text-sky-400 hover:text-sky-300" href="https://fidoalliance.org/passkeys/" rel="noopener noreferrer">
                    Passkeys overview
                  </a>
                  {' '}and the{' '}
                  <a className="text-sky-400 hover:text-sky-300" href="https://fidoalliance.org/specifications/" rel="noopener noreferrer">
                    CTAP2 specification
                  </a>
                </li>
                <li>
                  <a className="text-sky-400 hover:text-sky-300" href="https://passkeys.dev/" rel="noopener noreferrer">
                    passkeys.dev
                  </a>
