...
## 2026-09-05 | PR #34 | /guides/ssti-explained | Server-side template injection (SSTI) deep-dive with local lab | Strategy 2 | "server-side template injection / SSTI / SSTI payload / SSTI detection" | gates passed, awaiting review
